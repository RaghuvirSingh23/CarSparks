...
<title>CarSpark Incoming Vehicle</title>
				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-header">
							<strong class="card-title">MyBooking</strong>
						</div>
						<div class="card-body">
							<table class="table">
								<thead>
								...
								<tr>
									...
									<td><a
										href="view-user-incomingview-details.jsp?viewid=<%=resultset.getInt(1)%>&parkingNo=<%=resultset.getString(2)%>">Give Feedback</a>
										</td>
								</tr>
								<%
									}
