						...
						<div class="card-header">
							...
							<form action="AddOwnVehicle" method="post">
								...
								<div class="row form-group">
									...
									<div class="col col-md-3">
										<label for="select" class=" form-control-label">TimeSlot</label>
									</div>
										...
										<select name="timeslot" id="timeslot" class="form-control">
											...
											int result = 0;
												Connection conn = DatabaseConnection.getConnection();
													...
													result = preparedstatement.executeUpdate("UPDATE valmikibhavan SET Availablity = 'booked' WHERE TimeSlot = '10-11'; ");
													ResultSet rs = preparedstatement.executeQuery("SELECT * FROM valmikibhavan LIMIT 7; ");
													while (rs.next()) {
											%>
									...
									<div class="col col-md-3">
										<label for="select" class=" form-control-label">Avail Services</label>
									</div>
									...
									<div class="col-12 col-md-9">
										<select name="timeslot" id="timeslot" class="form-control">
											...
											<%
											//int result = 0;
												Connection connec = DatabaseConnection.getConnection();
													Statement preparedstatement1 = connec.createStatement();
													result = preparedstatement1.executeUpdate("UPDATE valmikibhavan SET services = 'wash+air' WHERE TimeSlot = '10-11'; ");
													ResultSet ras = preparedstatement.executeQuery("SELECT * FROM valmikibhavan LIMIT 3; ");
													while (ras.next()) {
											%>
											<option value="<%=ras.getString(4)%>"><%=ras.getString(4)%></option>
											<%
												}
											%>
										</select>
