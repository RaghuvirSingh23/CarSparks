...
<title>CarSparks Dashboard</title>
				...
				<%
					int count_today_vehentries = 0;
						...
						ResultSet resultset = statement
								.executeQuery("select count(*) from tblvehicle");
						...
						<div class="card-body">
							<div class="stat-widget-five">
								<div class="stat-icon dib flat-color-1">
									<i class="pe-7s-map-2" style = "color: #fc6233e;"></i>
								</div>
						...
						<div class="card-body">
							<div class="stat-widget-five">
								<div class="stat-icon dib flat-color-4">
									<i class="pe-7s-way" style = "color: #e74a3b;"></i>
								</div>
								<div class="stat-content">
									<div class="text-left dib">
										<div class="stat-text">
			...
			<div class="col-lg-6 col-md-6">
					...
					<div class="card">
						<div class="card-body">
							<div class="stat-widget-five">
								<div class="stat-icon dib flat-color-4">
									<i class="pe-7s-cash" style = "color: #1cc88a;"></i>
								</div>
								<div class="stat-content">
									<div class="text-left dib">
										<div class="stat-text">
				...
				<div class="col-lg-6 col-md-6">
					...
					<div class="card">
						<div class="card-body">
							<div class="stat-widget-five">
								<div class="stat-icon dib flat-color-4">
									<i class="pe-7s-users" style = "color: #4e73df;"></i>
								</div>
								<div class="stat-content">
									<div class="text-left dib">
										<div class="stat-text">
